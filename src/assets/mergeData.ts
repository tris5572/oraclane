...
const 茨城 = [
  ...
  },
  {
    ...
    angle: 205,
    merge: "right",
    comments: ["左車線は側道へ降りるクルマが多いため、早めに右に寄っておくのが良い。"],
  },
  {
    label: "国道6号 下り 白鳥バイパス分岐",
    longitude: 140.136643,
    latitude: 35.943869,
    angle: 10,
    merge: "right",
    comments: ["短区間のみ2車線になるが、白鳥バイパスとの分岐後すぐ右1車線になる。"],
  },
  {
    label: "国道6号 下り 藤代バイパス入口",
    longitude: 140.097886,
    latitude: 35.918219,
    angle: 50,
    merge: "left",
    comments: [
      "旧道と分岐する小浮気(こぶけ)交差点を過ぎるとすぐに左1車線に合流。",
      "交通量が多く合流しにくいので、手前から左に寄っておいた方が楽。",
      "少し手前に、水戸・土浦方面は左車線に寄ることを示す看板がある。",
    ],
  },
  {
...
const 埼玉 = [
  ...
  },
  {
    ...
    merge: "left",
    multi: true,
    comments: ["工事の関係で車線構造が変わることがあるが、とりあえず直進の場合は左2車線に寄っておけば間違いない。"],
  },
  {
  ...
  {
    label: "国道140号 彩甲斐街道 上り 中小前田",
    longitude: 139.205111,
    latitude: 36.123878,
    angle: 125,
    merge: "left",
    multi: true,
    comments: [
      "R140秩父方面からの2車線に、R254が合わさって3車線になり、すぐに右の1車線がなくなる。したがって秩父方面からは右1車線が消える形になる。",
      "合流地点が休日午後に渋滞していることも多いので、合流注意。",
    ],
  },
  {
    label: "県道26号 柏崎",
    longitude: 139.426835,
    latitude: 36.020276,
    angle: 150,
    merge: "left",
    comments: ["右車線のまま右折することも可能ではあるが、ほとんどのクルマは左折するはず。"],
  },
  {
...
const 千葉 = [
  ...
  },
  {
    ...
    angle: 280,
    merge: "right",
    comments: ["短距離のみ2車線。", "右1車線に絞り込まれた直後、交差点は左折・直進・右折の3レーン。"],
  },
  {
    label: "国道356号 下り 印西",
